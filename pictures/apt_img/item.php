...
<?php
	...
	<!-- listing inormation display here-->
	
	 <div class="well"> <span>  <h1> <?php echo $item_rs['title'];?></h1> </span> </div>
	...
	<span> <h2> Listing Details </h2> </span>
	...
	<hr/>
	<div class="listinginfo">
	<span> <h2> Building Details </h2> </span>
